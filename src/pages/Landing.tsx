...
const SCHEDULE = [
  ...
  { time: "15:00", title: "Full-Stack in the Age of AI — From Idea to Deployed App", desc: "Makinde Olasubomi shares how full-stack engineers can pair AI copilots with modern frameworks to architect, build, and ship complete web apps end-to-end at startup speed." },
